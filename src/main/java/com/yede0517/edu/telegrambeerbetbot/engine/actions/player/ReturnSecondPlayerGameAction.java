...
public class ReturnSecondPlayerGameAction extends AbstractGameAction implements Action {
    ...
    public void apply(Long chatId, Update update) {
        ...
        activeFrame.removeSecondPlayerPoint();
    ...
    public boolean isAppropriate(String command) {
        return command.contains(ActionIcons.RETURN_RIGHT_ICON);
    }
}
